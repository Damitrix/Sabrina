...
namespace Sabrina.Entities
{
	...
	{
		private static readonly char[] localInvalidChars = new char[] { '\"' };

		public static bool ContainsKey(this List<KeyValuePair<UserSetting.SettingID, UserSetting>> valueList, UserSetting.SettingID setting)
		{
		...
		public static string ToFormattedText(this Enum value)
		{
			...
			{
				if (char.IsUpper(stringVal[i]) && i != 0)
				{
					bld.Append(" ");
				}
