...
namespace Sabrina.Entities.SettingsModules
{
    internal class SissyModule : SettingsModule
    {
        ...
        internal override async Task<bool> Run()
        {
            ...
            builder.AddField("If you don't like being a sissy and traps in general, choose this.", UserSettingExtension.SissyLevel.None.ToString());
            builder.AddField("If you're new to being a sissy and traps, or just not interested that much. take this.", UserSettingExtension.SissyLevel.Light.ToString());
            builder.AddField("This setting is for regular sissy tasks and general trap porn.", UserSettingExtension.SissyLevel.Normal.ToString());
            builder.AddField("You're dressed with a cute skirt and socks right now? Maybe *only* a skirt and socks? :smug:", UserSettingExtension.SissyLevel.Hardcore.ToString());
            ...
            if (Enum.TryParse(m.Message.Content, true, out UserSettingExtension.SissyLevel sissyLevelPreference))
            {
            ...
            await UserSettingExtension.SetSettingAsync(_userId, UserSettingExtension.SettingID.SissyLevel, sissyLevel.ToString(), _context);
