...
{
    internal class PublicModule : PunishmentModule
    {
        public PublicModule(Dictionary<UserSettingExtension.SettingID, UserSetting> settings, List<WheelUserItem> items) : base(settings, items)
        {
        }
