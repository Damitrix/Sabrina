...
namespace Sabrina.Entities.WheelOutcomes
{
    ...
    internal sealed class Edge : WheelOutcome
    {
        ...
        /// The settings.
        /// </param>
        public Edge(WheelExtension.Outcome outcome, UserSettings settings, DiscordContext context) : base(outcome, settings, context)
        {
            ...
            {
                if (settings.WheelTaskPreference != null && ((WheelExtension.WheelTaskPreferenceSetting)settings.WheelTaskPreference).HasFlag(WheelExtension.WheelTaskPreferenceSetting.Time))
                {
                    this.Chance *= 3;
                }
            ...
            {
                if (settings.WheelTaskPreference != null && ((WheelExtension.WheelTaskPreferenceSetting)settings.WheelTaskPreference).HasFlag(WheelExtension.WheelTaskPreferenceSetting.Amount))
                {
                    this.Chance *= 3;
                }
